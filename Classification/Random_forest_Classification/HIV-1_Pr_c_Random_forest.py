...
class random_forest_HIV:

    try:
       # Intialize Random_forest for HIV Class With Parameter
...
random_forest_HIV(input_txt_path,input_path,training_path,testing_path,model_path)