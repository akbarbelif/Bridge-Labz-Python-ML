...
class Decision_tree_HIV:

    try:
       # Intialize Decision_tree for HIV Class With Parameter
...
training_path="../Decision_tree_Classifier/Data/HIV_training.csv"
testing_path="../Decision_tree_Classifier/Data/HIV_testing.csv"
Decision_tree_HIV(input_txt_path,input_path,training_path,testing_path,model_path)