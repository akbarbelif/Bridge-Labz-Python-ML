...
class logical_reg_HIV:

    try:
       # Intialize Logical Regression for HIV Class With Parameter
...
training_path="../Logical_Regression/Data/HIV_training.csv"
testing_path="../Logical_Regression/Data/HIV_testing.csv"
logical_reg_HIV(input_txt_path,input_path,training_path,testing_path,model_path)